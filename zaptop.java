...
public class zaptop extends JFrame{
	...
	private void initGUI() {
		...
		JLabel lblTitle = new JLabel("ZapTop");
		...
		panel.setCursor(Toolkit.getDefaultToolkit().createCustomCursor(
                loadImage("/handGun.jpg").getImage(),
	...
	private void clearBoard() {
		for(int i = 0; i < 16; i++){
		holes[i].setIcon(loadImage("/tableIn.png"));
		board[i] = 0;
		}
	}
	...
	private void genRandMole() {
        ...
        board[moleID] = 1;
        holes[moleID].setIcon(loadImage("/bossOut.jpg"));
	}
